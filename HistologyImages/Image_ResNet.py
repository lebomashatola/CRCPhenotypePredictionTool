...
class Prediction_Histology:
    ...
    def preprocess(self):
        ...
        os.chdir('/home/lebo/Documents')

        train_path = 'prediction/CNN/slides/train'
        valid_path = 'prediction/CNN/slides/validate'
        test_path = 'prediction/CNN/slides/test'
...
if __name__ == '__main__':
    ...
    model_run_2 = [hist_mobile, hist_resnet, hist_nesnet, hist_incept]

    for j in model_run_2:
